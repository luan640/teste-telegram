                            ...
                            for i, json_ in enumerate(json_transformed):
                                if json_['id'] == '237':
                                    ...
                                    if int(json_['results'][0]) == valor1 and int(json_['results'][1]) == valor2: #verifica se ainda está na mesma rodada
                                        ...
                                        if entrou:
                                            if (valor1 in duzia1 and valor2 in duzia1 and ultimo_valor in duzia1) or \
                                                (valor1 in duzia2 and valor2 in duzia2 and ultimo_valor in duzia2) or \
                                                (valor1 in duzia3 and valor2 in duzia3 and ultimo_valor in duzia3): #verifica se ganhou de primeira
                                                ...
                                                if gale1:
                                                    if (valor1 in duzia1 and valor2 in duzia1 and ultimo_valor in duzia1) or \
                                                        (valor1 in duzia2 and valor2 in duzia2 and ultimo_valor in duzia2) or \
                                                        (valor1 in duzia3 and valor2 in duzia3 and ultimo_valor in duzia3):
                                                        ...
                                                        telegram_bot('Gale 2 {}'.format(duzia_entrada),chat_id)
                                                        gale2=True    
                                                        gale1=None
                                                    ...
                                                    telegram_bot('Gale 1 {}'.format(duzia_entrada),chat_id)
                                                    gale1=True
